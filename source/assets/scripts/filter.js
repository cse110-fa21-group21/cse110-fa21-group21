...
function filterByTime(){
  ...
  const all_checked = document.querySelector("input[id=all_time]").checked;
    ...
    console.log(first_checked);
    console.log(second_checked);
    console.log(third_checked);
    console.log(fourth_checked);
    console.log(fifth_checked);
  ...
  recipeCards.forEach((element) =>{
    const recipeTime = extractCookingTime(
      ...
      if(all_checked || (!first_checked && !second_checked && !third_checked && !fourth_checked && !fifth_checked)){
        element.classList.add('shown');
        element.classList.remove('hidden');
        ...
        document.querySelector('input[id=all_time]').checked = false;
        element.classList.add('hidden');
        element.classList.remove('shown');
