export class Filter{
  ...
  #filterByDietary(recipeCard) {
     ...
     */
    const dairy_free_checked = document.querySelector("input[id=dairy-free-diet]").checked;
    const gluten_free_checked = document.querySelector("input[id=gluten-free-diet]").checked;
    const vegetarian_checked = document.querySelector("input[id=vegetarian-diet]").checked;
    const vegan_checked = document.querySelector("input[id=vegan-diet]").checked;
   ...
   */
  #checkDietaryChecked() {
    const first_checked = document.querySelector("input[id=dairy-free-diet]").checked;
    const second_checked = document.querySelector("input[id=gluten-free-diet]").checked;
    const third_checked = document.querySelector("input[id=vegetarian-diet]").checked;
    const fourth_checked = document.querySelector("input[id=vegan-diet]").checked;
  ...
  #extractDietary(recipeCard) {
     const dietary = {};
     dietary["dairy-free"] = !(recipeCard.shadowRoot.getElementById('dairy-free').hidden);
     dietary["gluten-free"] = !(recipeCard.shadowRoot.getElementById('gluten-free').hidden)
     dietary["vegetarian"] = !(recipeCard.shadowRoot.getElementById('vegetarian').hidden);
